...
//TODO: реализовать логику для многопользовательского звонка, то есть
//      сделать функционал с потоками и созданием сразу нескольких стримов которые могут принимать
//      фреймы от тех кто находиться в группе

//TODO: правильно завершать работу класса
